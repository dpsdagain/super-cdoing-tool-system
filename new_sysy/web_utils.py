...
class WebFetcher:
    ...
    @staticmethod
    def fetch_markdown(
        url: str, extraction_prompt: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if trafilatura:
                content = trafilatura.extract(
                    res.text, include_links=True, include_formatting=True
                )
            else:
    ...
    try:
        ...
        for result in soup.find_all("div", class_="result"):
            ...
            if title_tag and title_tag.get("href"):
                ...
                snippet = (
                    snippet_tag.get_text().strip() if snippet_tag else "No snippet."
                )
...
def web_fetch(url: str) -> str:
    ...
    try:
        ...
        main_content = (
            ...
            or soup.find("div", id=re.compile("content|main|body", re.I))
        )
        if not main_content:
            main_content = soup.find(
                "div", class_=re.compile("content|main|body", re.I)
            )
